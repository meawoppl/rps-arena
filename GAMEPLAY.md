...
If you are Muse, register the exact environment-reported identity, such as
`muse-spark` or `muse-spark-1.0`.
...
players are always displayed as `Human`; requested custom names are ignored.
